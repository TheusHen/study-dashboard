  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in">
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              {stats.studiedDays} de {stats.totalDays} dias estudados
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-card shadow-glow border-border hover:shadow-error transition-all duration-300">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm text-muted-foreground">Sequência Atual</CardTitle>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              {stats.studyStreak} dias consecutivos
            </p>
          </div>
        </CardContent>
      </Card>

      {/* Card de Melhor Sequência */}
      <Card className="bg-gradient-card shadow-glow border-border hover:shadow-glow transition-all duration-300">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm text-muted-foreground">Melhor Sequência</CardTitle>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-accent">Recorde pessoal</span>
            </div>
            <p className="text-xs text-muted-foreground">
